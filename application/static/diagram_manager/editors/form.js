...
class Form {
    ...
    show(step){
        ...
        this.modules.dialogs.open(this.elements.formComponent, {title:step.step.command, close:false, buttons:[{text:'Submit', callback:this.submitForm.bind(this)}]});
    ...
    submitForm(){
      ...
      this.modules.transport.send('formSubmit', {name:this.formName, data:this.form});
